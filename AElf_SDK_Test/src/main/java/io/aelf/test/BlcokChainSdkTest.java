...
public class BlcokChainSdkTest {
    ...
    public void executeTransactionAsyncTest() throws Exception{
        ...
        String param = Sha256.getSHA256("AElf.ContractNames.TokenConverter");
        String address=aelfSdk.getAddressFromPrivateKey(privateKeyHex);
        String toAddress = aelfSdk.getGenesisContractAddressAsync();
        TransactionDto transactionDtoObj=aelfSdk.generateTransaction(address,toAddress,methodName,param);
    ...
    public void executeRawTransactionAsyncTest() throws Exception{
        //String address="";
        String address="2bWwpsN9WSc4iKJPHYL4EZX3nfxVY7XLadecnNMar1GdSb4hJz";
        String toAddress = aelfSdk.getGenesisContractAddressAsync();
        String methodName = "GetContractAddressByName";
        String param = Sha256.getSHA256("AElf.ContractNames.Consensus");
        ...
        //mapParamsObj.put("value",base64.encodeToString(param.getBytes()));
        mapParamsObj.put("value","nd0rTlcBaus+Rf0Wu8xHhK+8Y4Sg+uqIQkorsKdx4M4=");
        ...
        //String transactionId=createRawTransactionOutputObj.getRawTransaction();
        String transactionId="";
        String signature="a1ef9740e0d61795ca543da46f591b079fc78138228e0eafdc1a05178816d987726e2657dcff001eeeb95ca746ed4e47e67ee3c16f8991a43fc159268264e68400";
        ExecuteRawTransactionDto executeRawTransactionDtoObj=new ExecuteRawTransactionDto();
        executeRawTransactionDtoObj.setRawTransaction(transactionId);
    ...
    public void rawTransactionAsyncTest() throws Exception{
        ...
        String toAddress = aelfSdk.getGenesisContractAddressAsync();
        String methodName = "GetContractAddressByName";
        String param = Sha256.getSHA256("AElf.ContractNames.Token");
        ChainstatusDto status = aelfSdk.getBlcokChainSdkObj().getChainStatusAsync();
        long height = status.getBestChainHeight();
        String blockHash = status.getBestChainHash();
        MapEntry mapParamsObj=Maps.newMapEntry();
        //Base64 base64 = new Base64();
        //mapParamsObj.put("value",base64.encodeToString(param.getBytes()));
        mapParamsObj.put("value","oqAPhYPAjaoAuAsLusRoQ5b+lmtoPqlWpjvYhF7uauc=");
        param=JSONUtil.toJSONString(mapParamsObj);
    ...
    public void sendRawTransactionAsyncTest() throws Exception{
        ...
        sendRawTransactionInputObj.setTransaction(transactionId);
