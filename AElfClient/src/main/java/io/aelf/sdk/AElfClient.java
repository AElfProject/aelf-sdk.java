...
public class AElfClient {
  ...
  public TransactionFeeResultOutput getTransactionFee(CalculateTransactionFeeInput input) throws Exception {
    return this.getBlockChainSdkObj().getTransactionFeeResult(input);
  }
