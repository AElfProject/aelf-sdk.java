...
public class AElfClient {
    ...
    /**
     * @param txId,privateKey
     * @return List<TokenContract.Transferred>
     * @throws Exception
     * @Description getTransferred
     */
    public List<TokenContract.Transferred> getTransferred(String txId, String privateKey) throws Exception {
        TransactionResultDto transactionResult = getTransactionResult(txId);
        String tokenContractAddress = getContractAddressByName(privateKey, Sha256.getBytesSha256("AElf.ContractNames.Token"));
        return TransactionResultDtoExtension.getTransferredEvent(tokenContractAddress, transactionResult);
    }

    public List<TokenContract.CrossChainReceived> getCrossChainReceived(String txId, String privateKey) throws Exception {
        TransactionResultDto transactionResult = getTransactionResult(txId);
        String tokenContractAddress = getContractAddressByName(privateKey, Sha256.getBytesSha256("AElf.ContractNames.Token"));
        return TransactionResultDtoExtension.getCrossChainReceivedEvent(tokenContractAddress, transactionResult);
    }

    public List<TokenContract.CrossChainTransferred> getCrossChainTransferred(String txId, String privateKey) throws Exception {
        TransactionResultDto transactionResult = getTransactionResult(txId);
        String tokenContractAddress = getContractAddressByName(privateKey, Sha256.getBytesSha256("AElf.ContractNames.Token"));
        return TransactionResultDtoExtension.getCrossChainTransferredEvent(tokenContractAddress, transactionResult);
    }
